...
![lec3_0.png](/kr/ros_basic_noetic/images3/lec3_0.png?height=200px)
...
![lec3_1.png](/kr/ros_basic_noetic/images3/lec3_1.png?height=400px)
...
![lec3_2.png](/kr/ros_basic_noetic/images3/lec3_2.png?height=200px)

```bash
roslaunch smb_gazebo smb_gazebo.launch
```

![lec3_3.png](/kr/ros_basic_noetic/images3/lec3_3.png?height=400px)
...
![lec3_4.png](/kr/ros_basic_noetic/images3/lec3_4.png?height=400px)
...
![lec3_5.png](/kr/ros_basic_noetic/images3/lec3_5.png?height=400px)
...
![lec3_6.png](/kr/ros_basic_noetic/images3/lec3_6.png?height=400px)

rviz에서 센서 데이터를 시각화하기 전, 우선 어떤 좌표계를 기준으로 시각화할지 설정해주어야 합니다.

같은 센서라도 원점 좌표계에서 본 모습과, 센서 좌표계에서 본 모습이 다르기 때문입니다.

![lec3_7.png](/kr/ros_basic_noetic/images3/lec3_7.png?height=300px)
...
![frame_rviz.gif](/kr/ros_basic_noetic/images3/frame_rviz.gif?height=400px)

이제 다양한 시각화 기능들을 사용해보려 합니다.

- 기본적으로 데이터의 추가는 왼쪽 하단 Add 버튼으로 실행합니다.

![lec3_8.png](/kr/ros_basic_noetic/images3/lec3_8.png?height=300px)

- tf 시각화

![rviz_tf.gif](/kr/ros_basic_noetic/images3/rviz_tf.gif?height=300px)

- odometry 시각화

![rviz_odom.gif](/kr/ros_basic_noetic/images3/rviz_odom.gif?height=300px)

- point cloud 시각화

![rviz_point_cloud.gif](/kr/ros_basic_noetic/images3/rviz_point_cloud.gif?height=300px)
...
![rviz_config.gif](/kr/ros_basic_noetic/images3/rviz_config.gif?height=300px)

아래와 같이 다양한 Plugin을 통해 여러 센서, 로봇 데이터를 시각화할 수 있으며, 자신만의 Plugin을 제작할 수도 있습니다.

![lec3_9.png](/kr/ros_basic_noetic/images3/lec3_9.png?height=300px)

지금까지 여러분들이 만든 RViz 설정을 저장해보고, launch file에 통합해봅시다.

- RViz의 좌측 상단 File 옵션을 사용하여 config file을 저장합니다.

![lec3_10.png](/kr/ros_basic_noetic/images3/lec3_10.png?height=200px)

- 저장 위치는 smb_gazebo/rviz로 지정하겠습니다. (새롭게 폴더를 만들어주었습니다.)

![lec3_11.png](/kr/ros_basic_noetic/images3/lec3_11.png?height=200px)
...
![lec3_12.png](/kr/ros_basic_noetic/images3/lec3_12.png?height=400px)

image from : [wiki.ros.org](http://wiki.ros.org/rqt_image_view)

- rqt multiplot

![lec3_13.png](/kr/ros_basic_noetic/images3/lec3_13.png?height=400px)

image from : [project march](https://docs.projectmarch.nl/doc/using_the_march_exoskeleton/how_to_view_live_data.html)

- rqt console

![lec3_14.png](/kr/ros_basic_noetic/images3/lec3_14.png?height=400px)

image from : [wiki.ros.org](http://wiki.ros.org/rqt_console)

- rqt robot steering

![lec3_15.png](/kr/ros_basic_noetic/images3/lec3_15.png?height=400px)

- rqt tf tree

![lec3_16.png](/kr/ros_basic_noetic/images3/lec3_16.png?height=400px)
